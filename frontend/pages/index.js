...
import { useSolCrypt } from '../hooks/solcrypt'
...
const Home = () => {
    ...
    const { avatar, userAddress, doTransaction, transactions, setNewTransactionModalOpen, newTransactionModalOpen } = useSolCrypt()

    return (
        <div className="flex min-h-screen ">
            <header className="flex w-[250px] flex-col bg-[#000534] p-12">
